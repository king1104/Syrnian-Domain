...
pre($_POST);
        ...
        $is_bound       = isset($_POST['bound'])    && !empty($_POST['bound'])    ? $_POST['bound'] === 'bound' : 0;
        $is_quest       = isset($_POST['quest'])    && !empty($_POST['quest'])    ? $_POST['quest'] === 'quest' : 0;
        $is_event       = isset($_POST['event'])    && !empty($_POST['event'])    ? $_POST['event'] === 'event' : 0;
